...
io.write('\27[1;31m 🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁🎃  ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
token = sudos.token 
--- start functions 🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁🎃
--------------------------------------------------------------------------------------------------------------
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/harwennotjoker/𝑨𝑵𝑯𝑬𝑳𝑺9/main/File_Bot/commands.lua") 
...
local UserName = (data.username_ or "𝑨𝑵𝑯𝑬𝑳𝑺teamm")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼《𝚂𝙾𝚄𝚁𝙲𝙴 𝑨𝑵𝑯𝑬𝑳𝑺》")  
...
local Text = ' ❤تم ارسال الملصق من 🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁?? \n - '..Name
...
os.execute('wget https://raw.githubusercontent.com/harwennotjoker/𝑨𝑵𝑯𝑬𝑳𝑺9/main/DRAGON.lua')
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس☎️', url="t.me/𝑨𝑵𝑯𝑬𝑳𝑺21"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/harwen7_7/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁🎃' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس انجيلز ادخل وتابع الجديد](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝑨𝑵𝑯𝑬𝑳𝑺》', url="t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == '━┅┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑨𝑵𝑯𝑬𝑳𝑺⟧⟝┄┉┉━' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس انجيلز ادخل وتابع الجديد](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)
]] 
keyboard = {}  
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_,0," ❤ الـعـضو  : {["..data.first_name_.."](T.ME/𝑨𝑵𝑯𝑬𝑳𝑺teamm)}\n ❤ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❤ عذرا  ⇦↯{["..data.first_name_.."](T.ME/𝑨𝑵𝑯𝑬𝑳𝑺teamm)}\n ❤ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'تحديث السورس' and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local 𝑨𝑵𝑯𝑬𝑳𝑺teamm = database:get(bot_id..'text:ch:user')
if 𝑨𝑵𝑯𝑬𝑳𝑺teamm then
send(msg.chat_id_, msg.id_,'['..𝑨𝑵𝑯𝑬𝑳𝑺teamm..']')
else
send(msg.chat_id_, msg.id_,' 🎃  لا تستطيع استخدام البوت \n  🎃  يرجى الاشتراك بالقناه اولا \n  🎃  اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/harwennotjoker/𝑨𝑵𝑯𝑬𝑳𝑺9/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/harwennotjoker/𝑨𝑵𝑯𝑬𝑳𝑺9/main/library')
os.execute('wget https://raw.githubusercontent.com/harwennotjoker/𝑨𝑵𝑯𝑬𝑳𝑺9/main/File_Bot')
send(msg.chat_id_, msg.id_,' 🎃  تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
if text == 'انجيلز' or text == 'سورس' or text == 'السورس' or text == 'source' or text == 'يا سورس' or text == '𝑨𝑵𝑯𝑬𝑳𝑺' then 
local Text = [[
 🎃 [𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑵𝑯𝑬𝑳𝑺](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)🎃 
 🎃 [𝑨𝑵𝑯𝑬𝑳𝑺 𝙏𝙃𝙀 𝘽𝙀𝙎𝙏 𝙎𝙊𝙐𝙍𝘾𝙀 𝙄𝙉 𝙏𝙀𝙇𝙀](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)🎃 
 🎃 [𝙊𝙑𝙀𝙍 𝙏𝙃𝙄𝙉𝙆𝙄𝙉𝙂 𝙆𝙄𝙇𝙇𝙎 𝙔𝙊𝙐𝙍 𝙃𝘼𝙋𝙋𝙄𝙉𝙀𝙎𝙎](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm) 🎃 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{{text = '  ❨  𝚂𝙾𝚄𝚁𝙲𝙴 𝑨𝑵𝑯𝑬𝑳𝑺  ❩ ',url="https://t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'جوكر راب' or text == 'مبرمج جوكر راب' or text == 'صاحب السورس' or text == 'بوضي' or text == 'بيوضي' or text == 'body' then 
local msg_id = msg.id_/2097152/0.5  
local Text = [[ 
jokerrap
   ]] 
...
if text == 'هروين' or text == 'مبرمج هروين' or text == 'هروين فين' or text == 'هروين فين' or text == 'هروين' or text == 'harwen' then 
local msg_id = msg.id_/2097152/0.5  
local Text = [[ 
harwen
   ]] 
...
if text == '《𝚂𝙾𝚄𝚁𝙲𝙴 𝑨𝑵𝑯𝑬𝑳𝑺》 ' then
local Text = [[ 
 ❤من أحسن السورسات على التليجرام سورس انجيلز ❤
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝑨𝑵𝑯𝑬𝑳𝑺](http://t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝑨𝑵𝑯𝑬𝑳𝑺》 ', url="t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm"}}, 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝑨𝑵𝑯𝑬𝑳𝑺》', url="t.me/jokerrap22_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/harwen7_7/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
function(arg,data) 
usertext = '\n ❤ الـعـضو   ⇦↯['..data.first_name_..'](t.me/'..(data.username_ or '𝑨𝑵𝑯𝑬𝑳𝑺teamm')..')'
...
usertext = '\n ❤ الـعـضو   ⇦↯['..result.title_..'](t.me/'..(username or '𝑨𝑵𝑯𝑬𝑳𝑺teamm')..')'
status  = '\n ❤ تم حظرو عام من الجروبات '
texts = usertext..status
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/enhar/𝑨𝑵𝑯𝑬𝑳𝑺9/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❤ اهلا بك في متجر ملفات انجيلز\n ❤ ملفات السورس 🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁🎃 \n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁🎃 \n ❤ علامة تعني { ✔️ } ملف مفعل\n ❤ علامة تعني { ✖ } ملف معطل\n ❤ قناة سورس انجيلز🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁🎃 \n".." ❤ [اضغط هنا لدخول](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/harwennotjoker/𝑨𝑵𝑯𝑬𝑳𝑺9/main/File_Bot/"..file)
if res == 200 then
...
t = "\n ❤ قائمه زوجات الجروب \n ❤▁▂▃▃▂▁❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝑨𝑵𝑯𝑬𝑳𝑺》 ](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)❳▁▂▃▃▂▁??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
' }\nء⧬━┅┅┄⟞❲[𝚂𝙾𝚄𝚁𝙲𝙴 𝙷??𝙶𝙰𝙽](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)❳⟝┄┉┉━⧬'..
'\n ❤  علامة ال {✓} تعني مفعل'..
'\n ❤  علامة ال {✘} تعني معطل'..
'\nء🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁🎃 '..
'\n'..' ❤  امر صيح  ⇦↯{ '..kickme..
...
' }\n'..' ❤  الايدي بالصوره  ⇦↯{ '..idph..
' }\n'..' ❤  الرفع  ⇦↯{ '..setadd..
' }\n'..' ❤  الحظر  ⇦↯{ '..banm..' }\n\n ❤▁▂▃▃▂▁❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝑨𝑵𝑯𝑬𝑳𝑺》 ](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)❳▁▂▃▃▂▁ ❤\n ❤ قناة سورس انجيلز🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁🎃 \n [ ❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝑨𝑵𝑯𝑬𝑳𝑺》 ](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)❳](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁🎃 \nاضغط علي الاسم ليتم نسخه\n🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁🎃 ٴ\n ❤ ❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝑨𝑵𝑯𝑬𝑳𝑺》 ](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)❳ ❤ ')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨𝚂𝙾𝚄𝚁𝙲𝙴 ❩', url="t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '《𝚂𝙾𝚄𝚁𝙲?? 𝑨𝑵𝑯𝑬𝑳𝑺》', url="t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 《𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙾??𝙰??》', url="t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm"}},
}
local msg_id = msg.id_/2097152/0.5
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري ولازم اعرصلك ينور عنيا🥺🤍](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري الثاني حته مني 😍💚](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور بس الصغنن 🌝💘](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه??🤦‍♂️](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مميز ابن ناس 😊 ](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مجرد عضو حقير ملكش لازمه 🌝💘 ](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
[[
↑🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁🎃 𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username ❤  
↑🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁🎃 𝙄𝘿 ➱ #id
↑🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁🎃 𝙍𝘼𝙉𝙆 ➱  #stast ❤  
↑🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁🎃 𝙈𝘼𝙎𝙂 ➱ #msgs ❤  
↑🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁🎃 𝗖𝗛 ➯  ↝@𝑨𝑵𝑯𝑬𝑳𝑺teamm↜ ❤  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁🎃 
 اختر الامر الذي تريدها .↑🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁🎃 
ده من الازرار بلاسفل . 🎃 ▁▂▃▃▂▁⟦𝑨𝑵𝑯𝑬𝑳𝑺⟧▁▂▃▃▂▁🎃 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝑨𝑵𝑯𝑬𝑳𝑺》 ](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)❳ 
]]
keyboard = {} 
...
•┉ • ┉ • ┉ 《 𝑨𝑵𝑯𝑬𝑳𝑺》 ┉ • ┉ • ┉•
 ...
 ❤ مسح الجروبات
•┉ • ┉ • ┉ 《𝑨𝑵𝑯𝑬𝑳𝑺》 ┉ • ┉ • ┉•
➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲e 𝑨𝑵𝑯𝑬𝑳𝑺.](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '( source 𝑨𝑵𝑯𝑬𝑳𝑺 )', url="t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑨𝑵𝑯𝑬𝑳𝑺⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑨𝑵𝑯𝑬𝑳𝑺⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝑨𝑵𝑯𝑬𝑳𝑺》 ](t.me/𝑨𝑵𝑯𝑬𝑳𝑺teamm)❳ 
]]
keyboard = {} 
