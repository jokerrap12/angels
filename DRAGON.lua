...
if text == ("رفع منشئ اساسي") or ("/monsh2") and msg.reply_to_message_id_ and CoSu(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
{
{text = 'رفع منشئ', callback_data="رفع منشئ"},{text = 'رفع منشئ اساسي', callback_data="رفع منشئ اساسي"},
},
{
